    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8 md:p-12">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Användarvillkor</h1>
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white dark:text-white mt-8 mb-4">1. Acceptans av villkor</h2>
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">2. Beskrivning av tjänsten</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Matvecka är en tjänst som hjälper användare att planera sina veckoköp genom att
              skapa veckomenyer baserade på aktuella erbjudanden från svenska matbutiker.
            </p>

            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">3. Användarkonto</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">4. Priser och erbjudanden</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">5. Recept och veckomenyer</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">6. Betalning och prenumeration</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Gratisversionen ger tillgång till 2 veckomenyer per vecka. Premium-prenumerationen
              kostar 99 kr/månad och ger obegränsad tillgång.
            </p>

            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">7. Avsluta konto</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">8. Ändringar i villkoren</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Vi kan uppdatera dessa villkor. Väsentliga ändringar meddelas via e-post eller
              i tjänsten.
            </p>

            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">9. Kontakt</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
