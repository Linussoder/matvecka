      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">1. Vilka uppgifter samlar vi in?</h2>
            <p className="text-gray-600 mb-4">Vi samlar in följande information:</p>
            <ul className="list-disc list-inside text-gray-600 mb-4 space-y-2">
              ...
              <li><strong>Användningsdata:</strong> Skapade matplaner och inköpslistor</li>
              <li><strong>Teknisk data:</strong> IP-adress, webbläsartyp (för att förbättra tjänsten)</li>
            </ul>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">2. Hur använder vi dina uppgifter?</h2>
            <p className="text-gray-600 mb-4">Vi använder dina uppgifter för att:</p>
            <ul className="list-disc list-inside text-gray-600 mb-4 space-y-2">
              <li>Skapa personliga matplaner baserade på dina preferenser</li>
              <li>Spara dina matplaner och inköpslistor</li>
              <li>Skicka viktig information om tjänsten</li>
              <li>Förbättra och utveckla Matvecka</li>
            </ul>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">3. Hur skyddar vi dina uppgifter?</h2>
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">4. Delning av uppgifter</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">6. Dina rättigheter (GDPR)</h2>
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">7. Datalagring</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">8. Barn</h2>
            <p className="text-gray-600 mb-4">
              Matvecka är inte avsett för barn under 16 år. Vi samlar inte medvetet in
              uppgifter från barn.
            </p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">9. Ändringar</h2>
            <p className="text-gray-600 mb-4">
              Vi kan uppdatera denna policy. Väsentliga ändringar meddelas via e-post.
            </p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">10. Kontakt</h2>
            <p className="text-gray-600 mb-4">
